...
% Set up te basic conditions
bmax =  1;     % Normalize bmax to 1
freq = 60;     % 60 Hz
w = 2*pi*freq; % angular velocity (rad/s)

% Frist , generate the three component magnetic fields
t = 0:1/6000:1/60;
...
% Plot the magnitude and directhion of the resulting magnetic field.
